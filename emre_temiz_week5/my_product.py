class Product:
    ...
    def get_details(self):
        return print(f"product_name:{self.product_name} product id:{self.product_id} product purchase price: {self.product_purchase_price} product sale price:{self.product_sale_price} remark:{self.set_remarks()} ")
